...
var require_usePlacesAutocompleteService = __commonJS({
  "node_modules/react-google-autocomplete/lib/usePlacesAutocompleteService.js"(exports) {
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    function usePlacesAutocompleteService(_ref) {
      ...
      var _useState = (0, _react.useState)([]), _useState2 = _slicedToArray(_useState, 2), placePredictions = _useState2[0], setPlacePredictions = _useState2[1];
      var _useState3 = (0, _react.useState)(false), _useState4 = _slicedToArray(_useState3, 2), isPlacePredsLoading = _useState4[0], setIsPlacePredsLoading = _useState4[1];
      var _useState5 = (0, _react.useState)(null), _useState6 = _slicedToArray(_useState5, 2), placeInputValue = _useState6[0], setPlaceInputValue = _useState6[1];
      var _useState7 = (0, _react.useState)(false), _useState8 = _slicedToArray(_useState7, 2), isQueryPredsLoading = _useState8[0], setIsQueryPredsLoading = _useState8[1];
      var _useState9 = (0, _react.useState)(false), _useState10 = _slicedToArray(_useState9, 2), queryInputValue = _useState10[0], setQueryInputValue = _useState10[1];
      var _useState11 = (0, _react.useState)([]), _useState12 = _slicedToArray(_useState11, 2), queryPredictions = _useState12[0], setQueryPredictions = _useState12[1];
      ...
      var debouncedPlacePredictions = (0, _react.useCallback)((0, _lodash.default)(function(optionsArg) {
        if (placesAutocompleteService.current && optionsArg.input)
          placesAutocompleteService.current.getPlacePredictions(_objectSpread(_objectSpread(_objectSpread({}, sessionToken && autocompleteSession.current ? {
      ...
      var debouncedQueryPredictions = (0, _react.useCallback)((0, _lodash.default)(function(optionsArg) {
        if (placesAutocompleteService.current && optionsArg.input)
          placesAutocompleteService.current.getQueryPredictions(_objectSpread(_objectSpread(_objectSpread({}, sessionToken && autocompleteSession.current ? {
            sessionToken: autocompleteSession.current
          } : {}), options), optionsArg), function(r) {
      ...
      (0, _react.useEffect)(function() {
        if (!_utils.isBrowser)
          return;
        var buildService = function buildService2() {
          if (!google)
...
export default require_usePlacesAutocompleteService();
//# sourceMappingURL=react-google-autocomplete_lib_usePlacesAutocompleteService.js.map
